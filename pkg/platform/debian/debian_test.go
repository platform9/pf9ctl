...
func TestIfSystemdTimesyncdServiceRunning(t *testing.T) {
	...
	cases := map[string]struct {
		...
		"CheckFail": {
			...
			want: want{
				result: false,
				err:    errors.New("systemd-timesyncd service is not running"),
			},
		},
	}
...
func TestIfNtpServiceRunning(t *testing.T) {
	type want struct {
		result bool
		err    error
	}
	...
	cases := map[string]struct {
		...
		//Success case. If ntp service is running.
		"CheckPass": {
			args: args{
				exec: &cmdexec.MockExecutor{
					MockRunWithStdout: func(name string, args ...string) (string, error) {
		...
		//Failure case. If ntp service is not running.
		"CheckFail": {
			args: args{
				exec: &cmdexec.MockExecutor{
					MockRunWithStdout: func(name string, args ...string) (string, error) {
			...
			want: want{
				result: false,
				err:    errors.New("ntp service is not running"),
			},
		},
	}
...
func TestIfChronydServiceRunning(t *testing.T) {
	type want struct {
		result bool
		err    error
	}
	...
	cases := map[string]struct {
		...
		//Success case. If chronyd service is running.
		"CheckPass": {
			args: args{
				exec: &cmdexec.MockExecutor{
					MockRunWithStdout: func(name string, args ...string) (string, error) {
		...
		//Failure case. If chronyd service is not running.
		"CheckFail": {
			args: args{
				exec: &cmdexec.MockExecutor{
					MockRunWithStdout: func(name string, args ...string) (string, error) {
			...
			want: want{
				result: false,
				err:    errors.New("chronyd service is not running"),
			},
		},
	}
